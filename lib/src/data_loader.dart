...
Map<String, dynamic> loadValidationData(String countryCode) {
  ...
  final filePath =
      path.join(Directory.current.path, validationDataDir, '$normalizedCountryCode.json');
...
({Map<String, dynamic> countryData, Map<String, dynamic> database}) loadCountryData(
    String? countryCode) {
